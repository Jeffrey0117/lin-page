...
(function() {
    ...
    // HTML 模板
    var template = '\
        <div class="fixed-buttons flex items-center flex-col fixed z-50 md:right-[40px] right-[20px] md:bottom-[40px] bottom-[20px]">\
            <a href="' + CONFIG.reserveLink + '"\
                class="reserve-btn group w-[45px] h-[45px] bg-[#C09771] hover:bg-[#a8835f] transition-all duration-300 flex items-center justify-center rounded-full border border-[#C09771] hover:border-[#a8835f]">\
                <span class="text-white text-[12px] font-bold">\u9810\u7D04</span>\
            </a>\
            <button id="service-toggle-btn"\
                class="service-btn group md:mt-[15px] mt-[8px] w-[45px] h-[45px] bg-black hover:bg-[#C09771] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#C09771] cursor-pointer"\
                aria-expanded="false" aria-label="\u5BA2\u670D">\
                <span class="text-white text-[12px] font-bold">\u5BA2\u670D</span>\
            </button>\
            <div id="service-list" class="service-list">\
                <a href="' + CONFIG.igLink + '" target="_blank"\
                    class="group md:mt-[15px] mt-[8px] w-[45px] h-[45px] bg-black hover:bg-[#C09771] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#C09771]">\
                    <svg class="w-[23px]" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">\
                ...
                <a href="' + CONFIG.fbLink + '" target="_blank"\
                    class="group md:mt-[15px] mt-[8px] w-[45px] h-[45px] bg-black hover:bg-[#C09771] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#C09771]">\
                    <svg class="w-[12px]" width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">\
                ...
                <a href="' + CONFIG.lineLink + '" target="_blank"\
                    class="group md:mt-[15px] mt-[8px] w-[45px] h-[45px] bg-black hover:bg-[#C09771] transition-all duration-300 flex items-center justify-center rounded-full border border-black hover:border-[#C09771]">\
                    <svg class="w-[28px]" width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">\
            ...
            <button class="group md:mt-[15px] mt-[8px] got_to_top overflow-hidden cursor-pointer w-[45px] h-[45px] bg-white hover:bg-[#C09771] transition-all duration-300 flex items-center justify-center rounded-full border border-[#C09771]">\
                <svg class="w-[16px]" width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">\
